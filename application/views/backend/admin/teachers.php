<div class="row bg-title">
    ...
    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
        <ol class="breadcrumb">
            <li>
                <a href="<?php echo base_url(); ?>index.php?admin/admin_dashboard"><?php echo get_phrase('Dashboard'); ?></a>
            </li>
                            ...
                            foreach ($teachers as $row):
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;" class="text-nowrap"><a
                                                href="<?php echo base_url(); ?>index.php?admin/teacher_profile/<?php echo $row['teacher_id']; ?>"
                                                data-toggle="tooltip" data-original-title="Profile"> <i
                                                    class="fa fa-user text-inverse m-r-10"></i></a><a href="#"
                                                                                                      data-toggle="tooltip"
                                                                                                      onclick="confirm_modal('<?php echo base_url(); ?>index.php?admin/teachers/delete/<?php echo $row['teacher_id']; ?>');"
                        ...
                        <div class="white-box">
                            ...
                            <div class="padded">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <!--StartUpdate-->
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label"><?php echo get_phrase('TSC NO'); ?></label>
                                        <div class="col-sm-5">
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="ti-ink-pen"></i></div>
                                                <input type="text" class="form-control" required="" name="tscNo"
                                                       placeholder="<?php echo get_phrase('TSC NO'); ?>">
                                            </div>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-sm-4 control-label"><?php echo get_phrase('National ID'); ?></label>
                                        <div class="col-sm-5">
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="ti-id-badge"></i></div>
                                                <input type="text" class="form-control" required="" name="nationalId"
                                                       placeholder="<?php echo get_phrase('National ID'); ?>">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6" style="align-items: baseline">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label"><?php echo get_phrase('Date Of Birth'); ?></label>
                                        <div class="col-sm-5">
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="ti-calendar"></i></div>
                                                <input type="text" class="form-control mydatepicker" required="" name="dob"
                                                       placeholder="<?php echo get_phrase('Date Of Birth'); ?>">
                                            </div>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-sm-4 control-label"><?php echo get_phrase('Date Of Appointment'); ?></label>
                                        <div class="col-sm-5">
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="ti-calendar"></i></div>
                                                <input type="text" class="form-control mydatepicker" required="" name="doa"
                                                       placeholder="<?php echo get_phrase('Date Of Appointment'); ?>">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-5">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="salary"
                                                       placeholder="<?php echo get_phrase('Salary'); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="field-1"
                                               class="col-sm-4 control-label"><?php echo get_phrase('Sex'); ?></label>
                                        <div class="col-sm-5">
                                    ...
                                    <div class="form-group">
                                        <label for="field-1"
                                               class="col-sm-4 control-label"><?php echo get_phrase('Photo'); ?></label>
