 ...
 * Time: 12:20 PM
 */
$edit_data		=	$this->db->get_where('departments' , array('department_id' => $param2) )->result_array();
        ...
        <div class="col-md-12">
            <div class="panel panel-info" data-collapsed="0">
                ...
                <div class="panel-body">
                    <?php echo form_open(base_url() . 'index.php?admin/manage_departments/do_update/'.$row['department_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
