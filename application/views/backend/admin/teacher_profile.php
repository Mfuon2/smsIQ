                    ...
                    <div class="white-box">
                        <div class="user-bg"><img src="style/images/large/img.jpg" alt="user" style="100%">
                            <div class="overlay-box">
                                <div class="user-content"><a href="javascript:void(0)"><img alt="img"
                                                                                            class="thumb-lg img-circle"
                                                                                            src="<?php echo $this->crud_model->get_image_url('teacher', $row['teacher_id']); ?>"></a>
                        ...
                        <hr>
                        <center>
                            <h3 class="box-title"><?php echo get_phrase('PersonalInfo'); ?></h3>
                            <h3 class="box-title"><?php echo "TSC - " . $row['tscNo']; ?></h3>
                        </center>
                        <ul class="basic-list">
                            <li><?php echo get_phrase('Name'); ?><span
                                        class="pull-right label-danger label"><?php echo $row['name']; ?></span></li>
                            <li><?php echo get_phrase('Username'); ?><span
                                        class="pull-right label-purple label"><?php echo $row['username']; ?></span>
                            </li>
                            <li><?php echo get_phrase('Phone'); ?><span
                                        class="pull-right label-red label"><?php echo $row['phone']; ?></span></li>
                            <li><?php echo get_phrase('Email'); ?><span
                                        class="pull-right label-success label"><?php echo $row['email']; ?></span></li>
                            <li><?php echo get_phrase('Birthday'); ?><span
                                        class="pull-right label-info label"><?php echo $row['birthday']; ?></span></li>
                            <li><?php echo get_phrase('Sex'); ?><span
                                        class="pull-right label-warning label"><?php if ($row['sex'] == 'male') echo get_phrase('Male');
                                    if ($row['sex'] == 'female') echo get_phrase('Female') ?></span></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-7">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            foreach ($edit_data as $row2):
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><?php echo get_phrase('TSC NO'); ?></label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="tscNo"
                                               value="<?php echo $row2['tscNo']; ?>"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="nationalId"
                                               value="<?php echo $row2['nationalId']; ?>"/>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><?php echo get_phrase('Date Of Appointment'); ?></label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control mydatepicker" name="doa"
                                               value="<?php echo $row2['doa']; ?>"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="field-2"
                                           class="col-sm-3 control-label"><?php echo get_phrase('Address'); ?></label>
                                ...
                                <div class="form-group">
                                    <label for="field-2"
                                           class="col-sm-3 control-label"><?php echo get_phrase('Phone'); ?></label>
                                ...
                                <div class="form-group">
                                    <label for="field-2"
                                           class="col-sm-3 control-label"><?php echo get_phrase('Salary'); ?></label>

                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" name="salary"
                                               value="<?php echo $row2['salary']; ?>">
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-5">
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail" style="width: 100px; height: 100px;"
                                                ...
                                                <img src="<?php echo $this->crud_model->get_image_url('teacher', $row2['teacher_id']); ?>"
                                                     alt="...">
                                            </div>
                    ...
                    <input type="file" name="userfile" accept="image/*">
                                                ...
                                                <a href="#" class="btn btn-orange fileinput-exists"
                                                   data-dismiss="fileinput"><?php echo get_phrase('Delete'); ?></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
